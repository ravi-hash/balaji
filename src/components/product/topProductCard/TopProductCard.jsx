...
const TopProductCard = () => {
  // Product information without imageURL
  const products = [
    {
      name: "Business Essentials",
      description: "Visiting cards, signs, posters, and essential marketing materials to help grow your business.",
      rating: 4.5,
    },
    {
      name: "Home & Gifts",
      description: "Mugs, drinkware, and gift hampers for a personalized touch, perfect for any occasion.",
      rating: 4.9,
    },
    {
      name: "Event Poster",
      description: "Get creative with customized event posters using our design services, logo makers, and QR code generators.",
      rating: 4.1,
    },
    {
      name: "Office Supplies",
      description: "From stamps to ink, find all the office essentials to keep your workplace running smoothly.",
      rating: 4.6,
    },
    {
      name: "Custom Polo T-Shirts",
      description: "Tailored custom polo shirts, ideal for your office or team branding needs.",
      rating: 4.3,
    },
    {
      name: "Calendars",
      description: "Personalized calendars to help you organize your year with a touch of style.",
      rating: 4.7,
    },
    {
      name: "Custom Poster",
      description: "Professional custom office posters designed to leave a lasting impression.",
      rating: 4.4,
    },
    {
      name: "Banner",
      description: "Custom banners to enhance visibility and make your message stand out.",
      rating: 4.5,
    },
  ];
  ...
  // Function to map product name to image
            ...
            <div className="parallax-card-container">
              <div className="parallax-card-layers">
                <div className="parallax-card-rendered-layer">
                  {/* Assign the image based on product name */}
